...
# ECR VPC Endpoints
# =============================================================================
# These endpoints allow ECS tasks in private subnets to pull images from ECR
# without going through NAT Gateway, saving costs and improving performance.
...
# CloudWatch Logs Endpoint (optional but recommended for ECS logs)
